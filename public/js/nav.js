...
function buildFooter(){
  return '<div class="footer-inner"><div class="footer-cols">'
    ...
    +'<li><a href="support.html">Центр поддержки</a></li><li><a href="faq.html">Часто задаваемые вопросы</a></li><li><a href="guide.html">Руководство по торговле</a></li><li><a href="news.html">Новости</a></li><li><a href="#">API документация</a></li>'
    +'</ul></div>'
